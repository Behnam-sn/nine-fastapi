...
class Follow():
    ...
    def get_count_by_follower_id(self, db: Session, follower_id: int) -> int:
        return db.query(models.Follow).filter(models.Follow.follower_id == follower_id).count()
    ...
    def get_count_by_following_id(self, db: Session, following_id: int) -> int:
        return db.query(models.Follow).filter(models.Follow.following_id == following_id).count()
